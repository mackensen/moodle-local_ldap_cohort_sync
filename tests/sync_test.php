...
require_once($CFG->dirroot.'/local/ldap_cohort_sync/locallib.php');
require_once($CFG->dirroot.'/auth/ldap/tests/plugin_test.php');

class local_ldap_cohort_sync_sync_testcase extends auth_ldap_plugin_testcase {
    public function test_auth_ldap() {
        ...
        $plugin = new local_ldap_cohort_sync();
        $plugin->sync_cohorts();
